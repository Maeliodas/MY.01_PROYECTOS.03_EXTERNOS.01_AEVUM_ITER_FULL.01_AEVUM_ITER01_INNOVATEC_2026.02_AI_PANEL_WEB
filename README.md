<div align="center">
  ...
  # Panel Aevum Iter APPROD4.1.8_R11_IN

  **Administración de orientación vocacional** — catálogos versionados, resultados en vivo y reportes PDF genéricos.

  [![release](https://img.shields.io/badge/release-APPROD4.1.8__R11__IN-0262FC?style=for-the-badge)](README_VERSION_4.1.8.md)
...
Esquema estilo ZZZ: siglas+canal pegados, versión y revisiones con guion bajo — `APPROD4.1.8_R11_IN`:
...
|---|---|---|
| [APPROD4.1.8_R11_IN](README_VERSION_4.1.8.md) | Rebrand total + pesos y códigos del rebalanceo RIASEC | [Ver detalle](README_VERSION_4.1.8.md) |

---

<div align="center">
  <sub>Panel Aevum Iter APPROD4.1.8_R11_IN · Rama Innovatec</sub>
</div>
